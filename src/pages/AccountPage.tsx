...
const accountSections = [
  ...
  {
    title: "Your Lists",
    description: "View and manage your wish lists",
    icon: Heart,
    href: "/lists",
  },
  {
  ...
  },
  {
    ...
    description: "Manage your seller profile and products",
    icon: Store,
    href: "/seller",
  },
];
      ...
      <div className="container py-8">
        ...
        <section className="mt-12">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link to="/orders" className="text-sm text-info hover:underline">
              View all orders
            </Link>
          </div>
